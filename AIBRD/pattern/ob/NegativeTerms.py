class NegativeTerms:
    ...
    ADJECTIVES = {"abnormal", "agressive", "ambiguous", "annoying",
                    ...
                    "worst", "wrong", "zombie"}
    ADVERBS = {"abnormally", "agressively", "annoyingly", "badly",
    ...
    VERBS = {"affect", "blink", "block", "break", "bypass", "clear",
    ...
    NOUNS = {"401", "403", "404", "504", "ambiguity", "ambiguuty",
